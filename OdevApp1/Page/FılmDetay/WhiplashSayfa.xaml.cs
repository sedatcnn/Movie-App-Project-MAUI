...
public partial class WhiplashSayfa : ContentPage
{
    ...
    private async void LoadFilmler()
    {
        ...
        Filmler = new ObservableCollection<FılmlerM>(filmler.Where(x => x.FılmAdı.Contains("Whiplash")));
