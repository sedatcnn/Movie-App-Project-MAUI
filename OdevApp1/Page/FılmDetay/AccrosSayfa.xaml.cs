...
public partial class AccrosSayfa : ContentPage
{
    ...
    private async void LoadFilmler()
    {
        ...
        Filmler = new ObservableCollection<FılmlerM>(filmler.Where(x => x.FılmAdı.Contains("Spider-Man: Across The Spider-Verse")));
