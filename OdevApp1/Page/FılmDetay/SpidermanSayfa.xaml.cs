...
public partial class SpidermanSayfa : ContentPage
{
    ...
    private async void LoadFilmler()
    {
        ...
        Filmler = new ObservableCollection<FılmlerM>(filmler.Where(x => x.FılmAdı.Contains("Örümcek-Adam Eve Dönüş Yok")));
