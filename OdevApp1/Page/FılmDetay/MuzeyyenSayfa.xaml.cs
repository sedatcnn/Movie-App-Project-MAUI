...
public partial class MuzeyyenSayfa : ContentPage
{
    ...
    private async void LoadFilmler()
    {
        ...
        Filmler = new ObservableCollection<FılmlerM>(filmler.Where(x => x.FılmAdı.Contains("Fakat Müzeyyen Bu Derin Bir Tutku")));
