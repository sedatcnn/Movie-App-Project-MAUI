...
public partial class SarmasıkSayfa : ContentPage
{
    ...
    private async void LoadFilmler()
    {
        ...
        Filmler = new ObservableCollection<FılmlerM>(filmler.Where(x => x.FılmAdı.Contains("Sarmaşık")));
